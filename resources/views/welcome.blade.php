...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
            <a href="{{ url('/hhome') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Home</a>
            @else
                    ...
                    <div class="p-6">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Larave has wonderful, thorough documentation covering every aspect of the framework.
